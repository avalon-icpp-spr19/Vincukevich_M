...
{	
	...
	cout << setw(17) << "Тип переиенной  " << "|" << internal << setw(10) << "Размер  " << "|" << setw(30) << "Значение                " << "|" << setw(13) << "Количество" << endl;
	cout << left;
	cout << setw(17) << "" << "|" << internal << setw(10) << "Байт  " << "|" << setw(10) << " Минимальноеэ  "   << "|   " << setw(10) << "Максимальное" << "|" << setw(13) <<  "  значимых бит" << endl;
	cout << left;
